...
export default class Criterion10_1 extends BaseCriterion {
  ...
  runTest() {
    ...
    const widthAttributeList = document.body.querySelectorAll('[width]:not(img, object, canvas, embed, svg, image, source)');
    const heightAttributeList = document.body.querySelectorAll('[height]:not(img, object, canvas, embed, svg, image, source)');
