...
export default class Criterion2_2 extends BaseCriterion {
  constructor(isTestMode: boolean = false) {
    ...
    this.messageList = {
      'NT': 'Vérifiez que le titre de chaque cadre est pertinent.',
  ...
  runTest() {
    ...
    let $frameList = Array.from(document.querySelectorAll(this.querySelector));
    if ($frameList.length) {
    ...
    this.elementList = frameTitleList;
